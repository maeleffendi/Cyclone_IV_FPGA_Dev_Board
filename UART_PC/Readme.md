...
![UART Block Diagram](images/uart_sch.png)
![UART Pin Assignment](images/uart_assignment.png)
...
![UART Protocol](images/uart_protocol.png)
...
![UART RX State Machine](images/uart_rx_sm.png)
...
![UART TX State Machine](images/uart_tx_sm.png)
...
![UART CH340](images/uart_ch340N.png)
...
![UART Terminal](images/UART_TERMINAL.png)
The scope shots below show the TX and RX signals at the output of the FPGA pins.
![UART Rx Scope](images/UART_RX_SCOPE.png)
![UART Tx Scope](images/UART_TX_SCOPE.png)
